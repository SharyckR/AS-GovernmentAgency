...
if __name__ == '__main__':
    ...
    mediator.link_education_history_to_person(person1.dni, edu_history1)
    # mediator.link_education_history_to_person(person2.dni, edu_history2)
    print("\n")

    mediator.link_fine_history_to_person(person1.dni, fine_history1)
    # mediator.link_fine_history_to_person(person2.dni, fine_history2)
    print("\n")

    mediator.link_vehicle_history_to_person(person1.dni, vehicle_history1)
    # mediator.link_vehicle_history_to_person(person2.dni, vehicle_history2)
    print("\n")

    mediator.link_case_history_to_person(person1.dni, case_history1)
    # mediator.link_case_history_to_person(person2.dni, case_history2)
    print("\n")

    mediator.link_medical_history_to_person(person1.dni, medical_history1)
    # mediator.link_medical_history_to_person(person2.dni, medical_history2)
    print("\n")

    print(get_person_info(person1.dni))
    print("\n")

    print(get_educational_history(person1.dni))
    print("\n")

    print(get_fine_history(person1.dni))
    print("\n")

    print(get_vehicle_history(person1.dni))
    print("\n")

    print(get_case_history(person1.dni))
    print("\n")

    print(get_medical_history(person1.dni))
    print("\n")
