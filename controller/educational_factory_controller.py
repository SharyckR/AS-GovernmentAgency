...
class EducationalFactoryController:
    def __init__(self):
        ...
        self.__education_histories: List = []
        self.load_data_db()
    ...
    def add_ed_history(self, dni_person: int, education: Optional[str], name_institution: Optional[str],
        ...
        if not any(eh['ID Person'] == educational_history.dni_person for eh in self.__education_histories):
            self.__education_histories.append(educational_history_dict)
