...
class EducationHistory(AbstractHistory, BaseModel):
    """
     ...
     Attributes:
            ...
            academic_achievements (List): Academics achievements of the person.
    ...
    def to_dict(self):
        ...
        return {
            str(self.dni_person): {
                ...
                "academic_achievements": academic_achievements_str,
    ...
    def __eq__(self, other):
        ...
        if isinstance(other, EducationHistory):
            return (self.id_history == other.id_history and self.dni_person == other.dni_person and
                    ...
                    self.academic_achievements == other.academic_achievements and
